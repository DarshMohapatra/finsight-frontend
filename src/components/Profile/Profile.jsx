  ...
  return (
    <div className="max-w-4xl mx-auto py-4 md:py-8">
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-8">
        ...
        <div className="w-full md:w-64 flex md:flex-col gap-2 overflow-x-auto pb-2 md:pb-0 scrollbar-hide">
          {tabs.map(tab => {
            const Icon = tab.icon
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 md:gap-3 px-4 py-2.5 md:py-3 rounded-xl transition-all font-mono text-sm whitespace-nowrap flex-shrink-0 md:w-full ${
                  active
                    ? tab.id === 'danger'
        ...
        {/* Content Area */}
        <div className="flex-1 bg-white/5 border border-white/10 rounded-2xl p-4 md:p-8 min-h-[400px]">
